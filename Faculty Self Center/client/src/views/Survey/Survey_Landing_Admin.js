...
const Survey_Landing_Admin = ({
  ...
  useEffect(() => {
    getAllSurveyForms();
    loadFaculty();
  }, [getAllSurveyForms, loadFaculty]);
  const classes = useStyles();
  return (
    <Fragment>
      {loading && faculty == null && surveys_all == null ? (
        <div>Looking</div>
      ) : (
        <Fragment>
                                    ...
                                    <StyledTableRow>
                                      ...
                                      <StyledTableCell align="right">
                                        <Button
                                          color="primary"
                                          round
                                          href={`/faculty/survey_form/${surveys._id}`}
                                          size="medium"
                                        >
                                          Fill Survey
                                        </Button>
...
export default connect(mapStateToProps, { getAllSurveyForms, loadFaculty })(
